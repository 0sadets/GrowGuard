...
export default function MainScreen() {
  ...
  useGreenhouseSignalR(connectedGreenhouseId, (statusWithAlerts) =>
    setConnectedStatus(statusWithAlerts.status)
  );
          ...
          {connectedGreenhouse &&
            renderItem({
              item: {
                ...connectedGreenhouse,
                name:
                  connectedGreenhouse.name ??
                  `Теплиця №${connectedGreenhouse.id}`,
